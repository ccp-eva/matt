export const translations = {
	...
	introParents: {
		'de-urban':
			'<p class="intro-text">Durch einen Klick auf das Lautsprecher-Symbol hören Sie eine kurze Begrüßung. Nachdem die Sprachaufnahme vollständig abgespielt ist, erscheint ein “weiter“-Knopf unten auf der Seite. Diesen drücken Sie bitte, wenn Sie mit Ihrem Kind die Spiele starten möchten.<br><br>In den Spielen wird Ihr Kind Dinge sortieren und Entscheidungen treffen. Außerdem stellen wir Ihrem Kind verschiedene Fragen. Lassen Sie dafür Ihr Kind selbst auf den Bildschirm tippen bzw. mit der Maus klicken. Wenn nötig, helfen Sie ihrem Kind beim Navigieren der Maus. An einigen Stellen hat Ihr Kind die Möglichkeit, verbal auf Fragen zu antworten. Das funktioniert entweder über eine Aufnahme mit dem Mikrofon Ihres Gerätes oder indem Sie oder Ihr Kind die Antwort Ihres Kindes in ein Textfeld schreiben. Geben Sie Ihrem Kind während der gesamten Studie bitte keinerlei Hinweise.<br><br>Bitte Klicken Sie nun auf das Lautsprecher-Symbol.</p>',
	},
