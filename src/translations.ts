export const translations = {
	...
	introChild: {
		'de-urban':
			'<p class="intro-text">Durch einen Klick auf das Lautsprecher-Symbol hören Sie eine kurze Begrüßung. Nachdem die Sprachaufnahme vollständig abgespielt ist, erscheint unten ein „weiter“-Knopf. Klicken Sie diesen, wenn Sie mit Ihrem Kind die Spiele starten möchten.<br><br>In den Spielen wird Ihr Kind Dinge sortieren und Entscheidungen treffen. Außerdem stellen wir Ihrem Kind verschiedene Fragen. Lassen Sie dafür Ihr Kind selbst auf den Bildschirm tippen bzw. mit der Maus klicken. Wenn nötig, helfen Sie ihrem Kind beim Navigieren der Maus.<br><br>An einigen Stellen hat Ihr Kind die Möglichkeit, auf offene Fragen zu antworten. Das funktioniert entweder über eine Sprachaufnahme mit dem Mikrofon Ihres Gerätes oder indem Sie oder Ihr Kind die Antwort Ihres Kindes in ein Textfeld schreiben. Geben Sie Ihrem Kind während der gesamten Studie bitte keinerlei Hinweise.<br><br>Bitte Klicken Sie nun auf das Lautsprecher-Symbol.</p>',
	...
	introAdult: {
		'de-urban':
			'<p class="intro-text">Durch einen Klick auf das Lautsprecher-Symbol hören Sie eine kurze Begrüßung. Nachdem die Sprachaufnahme vollständig abgespielt ist, erscheint unten ein “weiter“-Knopf. Klicken Sie diesen, wenn Sie die Studie starten möchten.<br><br>In der Studie werden Sie Dinge sortieren und Entscheidungen treffen. Außerdem stellen wir Ihnen verschiedene Fragen.<br>Bei den offenen Fragen, können Sie entweder über eine Sprachaufnahme mit dem Mikrofon Ihres Gerätes antworten oder indem Sie die Antwort in ein Textfeld schreiben.<br><br>Bitte Klicken Sie nun auf das Lautsprecher-Symbol.</p>',
		'idj-urban': '<h1 class="heading">Selamat datang dan senang bertemu kamu disini!</h1>',
		'pe-rural': '<h1 class="heading">¡Bienvenido y encantado de tenerte con nosotros!</h1>',
		'nam-rural': '<h1 class="heading">Kaise a !gậi !khais ge satsa nēpa ūhậ sa!</h1>',
	},
	...
	oneBike: {
		...
		'idj-urban': '<p class="dilemma">1 sepeda</p>',
		'pe-rural': '<p class="dilemma">1 bicicleta</p>',
	},
	...
	oneHuman: {
		'de-urban': '<p class="dilemma">1 Mensch</p>',
	...
	twoHumans: {
		'de-urban': '<p class="dilemma">2 Menschen</p>',
	...
	tenHumans: {
		'de-urban': '<p class="dilemma">10 Menschen</p>',
	...
	oneCat: {
		'de-urban': '<p class="dilemma">1 Katze</p>',
		'idj-urban': '<p class="dilemma">1 kucing</p>',
	},

	twoCats: {
		'de-urban': '<p class="dilemma">2 Katzen</p>',
		'idj-urban': '<p class="dilemma">2 kucing</p>',
	},

	tenCats: {
		'de-urban': '<p class="dilemma">10 Katzen</p>',
		'idj-urban': '<p class="dilemma">10 kucing</p>',
	},

	hundredCats: {
		'de-urban': '<p class="dilemma">100 Katzen</p>',
		'idj-urban': '<p class="dilemma">100 kucing</p>',
	},

	oneCow: {
		'de-urban': '<p class="dilemma">1 Kuh</p>',
	},

	twoCows: {
		'de-urban': '<p class="dilemma">2 Kühe</p>',
	},

	tenCows: {
		'de-urban': '<p class="dilemma">10 Kühe</p>',
	},

	hundredCows: {
		'de-urban': '<p class="dilemma">100 Kühe</p>',
	},

	oneDuiker: {
		'nam-rural': '<p class="dilemma">1/gâus</p>',
	},

	twoDuikers: {
		'nam-rural': '<p class="dilemma">2/gâura</p>',
	},

	tenDuikers: {
		'nam-rural': '<p class="dilemma">10/gâu-ti</p>',
	},

	hundredDuikers: {
		'nam-rural': '<p class="dilemma">100 /gâun</p>',
	},
	...
	tenNails: {
		'de-urban': '<p class="dilemma">10 Nägel</p>',
		'idj-urban': '<p class="dilemma">10 paku</p>',
		'pe-rural': '<p class="dilemma">10 clavos</p>',
		'nam-rural': '<p class="dilemma">10 Nägel</p>',
	},
	...
	feelingsRating: {
		...
		'idj-urban':
			'<p class="question">Seberapa banyak mereka dapat<br>merasa bahagia, sedih, atau takut?</p>',
		'pe-rural':
	...
	ownershipChild: {
		...
		'idj-urban':
			'<p class="question">Apakah kamu dan keluargamu memiliki<br>hewan, atau apakah ada hewan di rumahmu?</p>',
		'pe-rural':
	...
	exposureAdult: {
		...
		'idj-urban':
			'<p class="question">Seberapa sering kamu bertemu, atau pernahkah kamu<br>bertemu hewan-hewan ini sehari-hari?</p>',
		'pe-rural':
	...
	meatFish: {
		...
		'idj-urban': '<p class="question">Apakah kamu makan daging atau ikan?</p>',
		'pe-rural': '<p class="question">¿Comes carne o pescado?</p>',
	...
	thankYou: {
		'de-urban': '<h1 class="heading">Vielen Dank!</h1>',
