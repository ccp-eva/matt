...
export default async () => {
	...
	const yesButton = document.getElementById('link-s-giraffe-yes') as SvgInHtml;
	const noButton = document.getElementById('link-s-giraffe-no') as SvgInHtml;
	...
	play(`./cultures/${data.culture}/audio/s-giraffe.mp3`, 'link-s-giraffe-headphones');
