...
export default async () => {
	...
	const slidePrefix = 'sc1h10h';
	const leftPostfix = 'oneHuman';
	const rightPostfix = 'tenHumans';
	...
	await playPromise(`./cultures/${data.culture}/audio/${slidePrefix}-1h-left.mp3`);
	...
	play(`./cultures/${data.culture}/audio/${slidePrefix}-1h-left.mp3`, headphones.id);
