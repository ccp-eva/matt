...
export default async ({ currentSlide, previousSlide }) => {
	...
	data.procedure.sTaskPe = {
		...
		turkey: { circle: undefined, coords: { x: 0, y: 0 } },
	...
	var circles_id = ['st-inner2', 'st-middle2', 'st-outer2'];
	...
	const animals = ['chicken', 'pig', 'dog', 'turkey', 'parrot', 'cow', 'rabbit', 'cat'];
